...
nano Dockerfile
```
[Dockerfile](https://github.com/nataliya-panina/svirt/blob/devops/05-virt-03-docker-intro/Dockerfile)
...
```
![docker attach](https://github.com/nataliya-panina/svirt/blob/devops/05-virt-03-docker-intro/img/DockerAttach.png)  
...
![SIGINT](https://github.com/nataliya-panina/svirt/blob/devops/05-virt-03-docker-intro/img/SIGINT.png)
![SIGCHILD](https://github.com/nataliya-panina/svirt/blob/devops/05-virt-03-docker-intro/img/SIGCHILD.png)
...
```
![Volumes](https://github.com/nataliya-panina/svirt/blob/devops/05-virt-03-docker-intro/img/Volumes.png)
...
![Composes](https://github.com/nataliya-panina/svirt/blob/devops/05-virt-03-docker-intro/img/Composes.png)
...
docker compose up -d
```
![Both_composes](https://github.com/nataliya-panina/svirt/blob/devops/05-virt-03-docker-intro/img/Both_composes.png)
```
...
![error](https://github.com/nataliya-panina/svirt/blob/devops/05-virt-03-docker-intro/img/Faute.png)
## Deployment error
